...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FrameLayout fl = (FrameLayout) inflater.inflate(R.layout.fragment_fragment1, container, false);
    ...
    public void setWebView1(){
        ...
        mWebView.loadUrl("https://blog.naver.com/onlybabylove/220951973542");
    }
    ...
    public class JavaScriptInterface {
        ...
        public void changePage(String idxNum){
            ...
            ft.replace(R.id.fragment_container, new Fragment1()).commit();
        }
    }
